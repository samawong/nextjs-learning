    ...
    <>
      <nav className="relative container m-auto p-6 bg-white dark:bg-black">
        <div className="flex  items-center justify-between">
          ...
          <a href="#" className="hidden px-6 pt-2 p-3 text-white  dark:bg-dark dark:text-white bg-brightRed rounded-full baseline hover:bg-brightRedLight  md:block">Get Started</a>
          ...
          <button id="menu-btn" className={isNavOpen ? "open block hamburger md:hidden focus:outline-none dark:bg-white" : 'block hamburger md:hidden focus:outline-none  dark:bg-white'} onClick={() => {setIsNavOpen(!isNavOpen);console.log(isNavOpen)}}>
